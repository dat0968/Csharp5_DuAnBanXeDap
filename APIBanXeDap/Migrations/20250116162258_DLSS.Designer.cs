            ...
            modelBuilder.Entity("APIBanXeDap.Models.MaCoupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 15, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5295),
                            NgayTao = new DateTime(2025, 1, 16, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5266),
                            SoTienGiam = 50000m,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 1, 31, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5312),
                            NgayTao = new DateTime(2025, 1, 16, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5309),
                            PhanTramGiam = 10f,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 5, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5317),
                            NgayTao = new DateTime(2025, 1, 16, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5316),
                            SoTienGiam = 100000m,
                            TrangThai = false
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 1, 26, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5323),
                            NgayTao = new DateTime(2025, 1, 16, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5322),
                            PhanTramGiam = 20f,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 10, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5328),
                            NgayTao = new DateTime(2025, 1, 16, 23, 22, 55, 63, DateTimeKind.Local).AddTicks(5327),
                            SoTienGiam = 150000m,
                            TrangThai = true
                        });
                });
