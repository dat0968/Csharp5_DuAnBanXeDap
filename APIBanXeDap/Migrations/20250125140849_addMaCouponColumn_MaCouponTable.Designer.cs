...
namespace APIBanXeDap.Migrations
{
    ...
    [Migration("20250125140849_addMaCouponColumn_MaCouponTable")]
    partial class addMaCouponColumn_MaCouponTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIBanXeDap.Models.MaCoupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 24, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1169),
                            NgayTao = new DateTime(2025, 1, 25, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1151),
                            SoTienGiam = 50000m,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 9, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1179),
                            NgayTao = new DateTime(2025, 1, 25, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1177),
                            PhanTramGiam = 10f,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 14, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1182),
                            NgayTao = new DateTime(2025, 1, 25, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1181),
                            SoTienGiam = 100000m,
                            TrangThai = false
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 4, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1186),
                            NgayTao = new DateTime(2025, 1, 25, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1185),
                            PhanTramGiam = 20f,
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayHetHan = new DateTime(2025, 2, 19, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1190),
                            NgayTao = new DateTime(2025, 1, 25, 21, 8, 48, 509, DateTimeKind.Local).AddTicks(1188),
                            SoTienGiam = 150000m,
                            TrangThai = true
                        });
                });
